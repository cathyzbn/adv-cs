  ...
  implements MouseListener, MouseMotionListener, KeyListener
{
  ...
  public void addBalloon(int shape)
  {
    ...
    switch (shape)
    {
      case 1: activeBalloon = new RoundBalloon(w/2, h/2, radius, color); Balloon b = new RoundBalloon(); break;
    ...
    //testing for override toString
    System.out.println(activeBalloon);
    repaint();
  }
