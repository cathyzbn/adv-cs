...
public class Magpie4
{
	...
	private String transformYouMeStatement(String statement)
	{
		...
		int psnOfAre = findKeyword(restOfStatement, "are", 0);
		if(psnOfAre>=0) {
			restOfStatement = restOfStatement.replace("are", "am");
		}
	...
	private String transformIYouStatement(String statement)
	{
		...
		int psnOfAm = findKeyword(restOfStatement, "am", 0);
		if(psnOfAm>=0) {
			restOfStatement = restOfStatement.replace("am", "");
